...
$tabela = "samjf_m8_crimes_contra_adm_mens_2016";
//$p81 = $_REQUEST['p81'];
//$p82 = $_REQUEST['p82'];
$p83 = $_REQUEST['p83'];
...
$sql = "update samjf_m8_crimes_contra_adm_mens_2016 set p83='$p83' where id=$id";
...
$mensagem= "Alterou os valores de p83='$p83' where id=$id";
salvaLog($mensagem);
?>