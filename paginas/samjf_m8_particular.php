...
<head>
	...
	<title>Crimes praticados por particular contra a administração em Geral</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: 'get_samjf_m8_particular.php',
				saveUrl: 'save_samjf_m8_particular.php',
				updateUrl: 'update_samjf_m8_particular.php',
				destroyUrl: 'destroy_samjf_m8_particular.php',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<table id="dg" title="Crimes praticados por particular contra a administração em Geral" style="width:1000px;height:500px; border:1px solid #ccc;"
