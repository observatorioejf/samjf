...
<head>
	...
	<title>Redução à condição análoga à de escravo</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: 'get_samjf_m8_escravo.php',
				saveUrl: 'save_samjf_m8_escravo.php',
				updateUrl: 'update_samjf_m8_escravo.php',
				destroyUrl: 'destroy_samjf_m8_escravo.php',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<h2>Redução à condição análoga à de escravo</h2>
	
	<?php
		include ("include/instrucoes.php");
	?>
	
	<table id="dg" title="Redução à condição análoga à de escravo" style="width:1000px;height:500px; border:1px solid #ccc;"
