...
<head>
	...
	<title>Crimes contra a administração da justiça</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: 'get_samjf_m8_justica.php',
				saveUrl: 'save_samjf_m8_justica.php',
				updateUrl: 'update_samjf_m8_justica.php',
				destroyUrl: 'destroy_samjf_m8_justica.php',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<table id="dg" title="Crimes contra a administração da justiça" style="width:1000px;height:500px; border:1px solid #ccc;"
