...
<head>
	...
	<title>Meta 13 Magistrados</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: 'get_samjf_m13_serv_tri_2016.php',
				saveUrl: '',
				updateUrl: 'update_samjf_m13_serv_tri_2016.php',
				destroyUrl: '',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<h2>Meta 13 Magistrados. Atingir 100% de adesão de magistrados ao exame de saúde periódico, até 2020.</h2>
	...
	<table id="dg" title="" style="width:700px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="proc" width="50" editor="text">Istância</th>
				<th field="p131" width="50" editor="text">P13.1</th>
				<th field="p132" width="50" editor="text">P13.2</th>			
