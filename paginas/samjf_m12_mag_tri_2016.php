...
<head>
	...
	<title>SAMJF - Meta12 Magistrados</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: 'get_samjf_m12_mag_tri_2016.php',
				saveUrl: '',
				updateUrl: 'update_samjf_m12_mag_tri_2016.php',
				destroyUrl: '',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<h2>Meta 12 Magistrados. Manter, em todos os anos, o absenteísmo de magistrados abaixo ou igual a 3%. </h2>
