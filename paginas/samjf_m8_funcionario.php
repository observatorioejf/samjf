...
<head>
	...
	<title>Crimes praticados por funcionário público contra a administração em Geral</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: 'get_samjf_m8_funcinario.php',
				saveUrl: 'save_samjf_m8_funcinario.php',
				updateUrl: 'update_samjf_m8_funcinario.php',
				destroyUrl: 'destroy_samjf_m8_funcinario.php',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<h2>Crimes praticados por funcionário público contra a administração em Geral</h2>
	
	<?php
		include ("include/instrucoes.php");
	?>
	
	<table id="dg" title="Crimes praticados por funcionário público contra a administração em Geral" style="width:1000px;height:500px; border:1px solid #ccc;"
