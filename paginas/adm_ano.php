...
?>
<!-- imprime o login -->
<h1>Olá, <?php echo $_SESSION['UsuarioID'];  ?>!</h1>
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
			  ...
			  <h3><b>Selecione o ano da Meta</b></h3>
			  ...
			  <i class="fa fa-check-square-o fa-2x"></i> <font size="3"><a href="adm_samjf.php"><b>2016</b></a></font><br><br>
			  <i class="fa fa-check-square-o fa-2x"></i> <font size="3"><a href="Manutenção da página.html"><b>2015</b></a></font><br><br>
