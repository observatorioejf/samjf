...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: 'get_samjf_m9_unic_2016.php',
				saveUrl: '',
				updateUrl: 'update_samjf_m9_unic_2016.php',
				destroyUrl: '',
				fitColumns: true
			});
			var dg = $('#dg');
	...
	<table id="dg" title="" style="width:1000px;height:500px; border:1px solid #ccc;"
		...
		<thead>
			<tr>
				...
				<th field="proc" width="40" editor="text">Instância</th>
				<th field="p91" width="30" editor="text">P9.1</th>
				<th field="p92" width="30" editor="text">p9.2</th>
