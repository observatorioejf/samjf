...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#dg').edatagrid({
				url: 'get_samjf_m8_exploracao.php',
				saveUrl: 'save_samjf_m8_exploracao.php',
				updateUrl: 'update_samjf_m8_exploracao.php',
				destroyUrl: 'destroy_samjf_m8_exploracao.php',
				fitColumns: true
			});
			var dg = $('#dg');
...
<body>
	...
	<table id="dg" title="Exploração sexual" style="width:1000px;height:500px; border:1px solid #ccc;"
